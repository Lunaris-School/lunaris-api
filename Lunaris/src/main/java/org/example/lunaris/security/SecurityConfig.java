...
public class SecurityConfig {
    ...
    private void configurarRotasAdmin(AuthorizeHttpRequestsConfigurer<HttpSecurity>.AuthorizationManagerRequestMatcherRegistry authorize){
        ...
        authorize.requestMatchers("/api/professor/inserir").hasRole("ADMIN");
        ...
        authorize.requestMatchers("/api/professor/atualizar/{id}").hasRole("ADMIN");
    ...
    private void configurarRotasAluno(AuthorizeHttpRequestsConfigurer<HttpSecurity>.AuthorizationManagerRequestMatcherRegistry authorize){
        ...
        authorize.requestMatchers("/observacao/buscar/aluno/").hasAnyRole("ALUNO", "PROFESSOR");
        authorize.requestMatchers("/api/professor/listarTodos").hasAnyRole("ALUNO", "ADMIN", "PROFESSOR");
    }
